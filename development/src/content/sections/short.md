...
Lists are essential for organizing information. Here we explore different list styles and nesting capabilities.
...
1.  **Step One**: Initialize the process.
2.  **Step Two**: Configure the settings.
    1.  Select the desired options.
    2.  Confirm the selection.
3.  **Step Three**: Execute the command.
...
This final section tests how blockquotes and code blocks interact with the layout, ensuring they are readable and distinct.
...
Here is a simple Javascript snippet:
